...
const FOOD_NAME_TRANSLATIONS = {
  "Arroz branco, cozido": "Cooked white rice",
  "Pão francês": "French bread",
  "Macarrão, cozido": "Cooked pasta",
  "Aveia em flocos": "Rolled oats",
  "Milho verde, cozido": "Cooked sweet corn",
  "Pão de forma integral": "Whole wheat sliced bread",
  "Tapioca (goma hidratada)": "Tapioca (hydrated gum)",
  "Cuscuz de milho, cozido": "Cooked corn couscous",
  "Quinoa, cozida": "Cooked quinoa",
  "Quinoa cozida": "Cooked quinoa",
  "Biscoito cream cracker": "Cream cracker biscuit",
  "Alface": "Lettuce",
  "Tomate": "Tomato",
  "Cenoura, cozida": "Cooked carrot",
  "Cenoura crua": "Raw carrot",
  "Brócolis, cozido": "Cooked broccoli",
  "Brócolis cozido": "Cooked broccoli",
  "Batata doce, cozida": "Cooked sweet potato",
  "Batata-doce cozida": "Cooked sweet potato",
  "Abobrinha, cozida": "Cooked zucchini",
  "Couve refogada": "Sauteed collard greens",
  "Espinafre, cozido": "Cooked spinach",
  "Pimentão": "Bell pepper",
  "Beterraba, cozida": "Cooked beet",
  "Banana prata": "Silver banana",
  "Maçã": "Apple",
  "Maçã com casca": "Apple with skin",
  "Laranja": "Orange",
  "Laranja pera": "Pera orange",
  "Mamão formosa": "Formosa papaya",
  "Manga": "Mango",
  "Açaí (polpa congelada)": "Frozen acai pulp",
  "Abacate": "Avocado",
  "Uva": "Grape",
  "Melancia": "Watermelon",
  "Morango": "Strawberry",
  ...
  "Peito de frango grelhado": "Grilled chicken breast",
  "Bife de alcatra, grelhado": "Grilled sirloin steak",
  "Ovo, cozido": "Cooked egg",
  "Ovo de galinha cozido": "Cooked chicken egg",
  "Salmão, assado": "Baked salmon",
  "Patinho moído, cozido": "Cooked ground beef",
  "Patinho bovino cozido": "Cooked lean beef (patinho)",
  "Tilápia, assada": "Baked tilapia",
  "Tilápia grelhada": "Grilled tilapia",
  "Linguiça toscana, frita": "Fried Tuscan sausage",
  "Atum em lata (em óleo)": "Canned tuna (in oil)",
  "Lombo de porco, assado": "Baked pork loin",
  "Peito de peru defumado": "Smoked turkey breast",
  "Leite integral": "Whole milk",
  "Queijo minas frescal": "Minas fresh cheese",
  "Iogurte natural integral": "Whole natural yogurt",
  "Queijo muçarela": "Mozzarella cheese",
  "Requeijão cremoso": "Creamy requeijao cheese",
  ...
  "Feijão carioca, cozido": "Cooked carioca beans",
  "Lentilha, cozida": "Cooked lentil",
  "Lentilha cozida": "Cooked lentil",
  "Grão-de-bico, cozido": "Cooked chickpea",
  "Grão-de-bico cozido": "Cooked chickpea",
  "Soja, cozida": "Cooked soy",
  "Ervilha, enlatada": "Canned pea",
  "Ervilha cozida": "Cooked pea",
  "Castanha-do-pará": "Brazil nut",
  "Amendoim, torrado": "Roasted peanut",
  "Castanha de caju, torrada": "Roasted cashew nut",
  "Nozes": "Walnuts",
  "Amêndoas": "Almonds",
  "Amêndoa": "Almond",
  "Azeite de oliva extra virgem": "Extra virgin olive oil",
  "Azeite de oliva extravirgem": "Extra virgin olive oil",
  ...
  "Salsicha": "Sausage",
  "Nuggets de frango, frito": "Fried chicken nuggets",
  "Lasanha bolonhesa congelada": "Frozen lasagna bolognese",
  "Pizza de muçarela": "Mozzarella pizza",
  "Hambúrguer de carne": "Beef burger",
  "Molho de tomate pronto": "Ready-made tomato sauce",
  "Macarrão instantâneo": "Instant noodles",
  "Batata frita (fast food)": "French fries (fast food)",
  "Suco de laranja natural": "Natural orange juice",
  "Café coado, sem açúcar": "Brewed coffee, unsweetened",
  "Água de coco": "Coconut water",
  "Cerveja Pilsen": "Pilsen beer",
  "Vinho tinto seco": "Dry red wine",
  "Feijoada": "Feijoada (pork and black bean stew)",
  "Moqueca de peixe": "Fish moqueca (stew)",
  "Strogonoff de frango": "Chicken stroganoff",
  "Pão de queijo": "Cheese bread",
  "Coxinha de frango": "Chicken coxinha (croquette)",
  "Farofa de mandioca": "Cassava farofa",
  "Salada de maionese": "Potato salad (with mayonnaise)",
  "Arroz de carreteiro": "Carreteiro rice",
  "Vaca atolada": "Vaca atolada (beef and cassava stew)",
  "Escondidinho de carne seca": "Dried beef escondidinho (shepherd's pie)",
  "Canjica": "Canjica (sweet corn hominy)",
  "Brigadeiro": "Brigadeiro (chocolate truffle)",
  "Bolo de cenoura com cobertura": "Carrot cake with chocolate topping",
  "Pastel de carne, frito": "Fried beef pastel",
  "Acarajé": "Acaraje (deep-fried black-eyed pea fritter)",
  ...
  "Abóbora cozida": "Cooked pumpkin",
  "Tomate cru": "Raw tomato",
  "Sardinha assada": "Baked sardine"
};
...
function rowsToFoods(rows, startId) {
  ...
  for (const r of data) {
    ...
    foods.push({
      id: `f${id++}`,
      name: rawName,
      nameEn: FOOD_NAME_TRANSLATIONS[rawName] || rawName,
      category,
      portion: "100",
      unit: "g",
